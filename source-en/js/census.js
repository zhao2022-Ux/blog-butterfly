...
var metricsName = (metrics === 'pv_count' ? 'PV' : (metrics === 'visitor_count' ? 'UV' : ''))
...
function mapChart() {
  ...
  fetch(dataUrl + paramUrl).then(data => data.json()).then(data => {
    ...
    script.innerHTML = `
      ...
      var mapOption = {
        title: {
          text: 'Geographical distribution map of website visitors 🌏',
          x: 'center',
          textStyle: {
            color: '${color}'
          }
...
function trendsChart() {
  ...
  fetch(dataUrl + paramUrl).then(data => data.json()).then(data => {
    ...
    script.innerHTML = `
      ...
      var trendsOption = {
        title: {
          text: 'Website Visitor Date Distribution Map 📅',
          x: 'center',
          textStyle: {
            color: '${color}'
          }
...
function sourcesChart() {
  ...
  fetch(dataUrl + paramUrl).then(data => data.json()).then(data => {
    ...
    script.innerHTML = `
      ...
      var sourcesOption = {
        title: {
          text: 'Website Visitor Source Distribution Map 🎨',
          x: 'center',
          textStyle: {
            color: '${color}'
          }
