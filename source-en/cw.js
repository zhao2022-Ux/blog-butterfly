...
const handleerr = async (req, msg) => {
    return new Response(`<h1>CDN splitter encountered a fatal error</h1>
...
const generate_blog_urls = (packagename, blogversion, path) => {
    const npmmirror = [
        ...
        `https://en.vercel.blog.sinzmise.top`,
        `https://en.netlify.blog.sinzmise.top`,
        `https://jsd.cdn.storisinz.site/gh/SinzMise/blog@en`,
